...
public class OpenNotifyDialog extends Dialog {
	...
	public OpenNotifyDialog(Context context, int theme) {
	...
	public static class Builder {
		...
		public OpenNotifyDialog create() {
			...
			final OpenNotifyDialog dialog = new OpenNotifyDialog(context,
					R.style.Dialog);

			dialog.setCanceledOnTouchOutside(false);

			View layout = inflater.inflate(R.layout.dialog_notify_layout, null);
